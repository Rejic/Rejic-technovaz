...
// Page view code for homePage
// router.get('/', function(req, res) {
//    if( req.session.page_views) {
//       const number = req.session.page_views; 
//      req.session.page_views++;
//      res.send(`Number of page visit: ${number}`);
//    } else {
...
router.get('/regions', hotelController.listAllRegions);
router.get('/regions/:region', hotelController.hotelsByRegion);
router.post('/results', hotelController.searchResults);

// RESULT

router.post('/',hotelController.hotelResultPost);
